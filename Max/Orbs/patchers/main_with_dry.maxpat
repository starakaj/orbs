...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1573.5, 289.0, 81.5, 13.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1048.942383, 520.0, 81.5, 13.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 1573.5, 264.0, 81.5, 25.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1048.942383, 495.0, 81.5, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1631.333252, 204.0, 50.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1141.0, 500.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1620.0, 184.0, 50.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1141.0, 483.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1605.0, 169.0, 50.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1141.0, 463.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1513.0, 212.0, 73.0, 20.0 ],
					"text" : "yafr"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1708.0, 451.0, 58.0, 18.0 ],
					"presentation_rect" : [ 1686.192383, 691.0, 0.0, 0.0 ],
					"text" : "send~ m-4"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1631.333252, 451.0, 58.0, 18.0 ],
					"presentation_rect" : [ 1609.525635, 691.0, 0.0, 0.0 ],
					"text" : "send~ m-3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1554.666626, 451.0, 58.0, 18.0 ],
					"presentation_rect" : [ 1532.859009, 691.0, 0.0, 0.0 ],
					"text" : "send~ m-2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1478.0, 451.0, 58.0, 18.0 ],
					"presentation_rect" : [ 1456.192383, 691.0, 0.0, 0.0 ],
					"text" : "send~ m-1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1478.0, 314.0, 249.0, 128.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 965.192383, 545.0, 249.0, 128.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1478.0, 289.0, 81.5, 13.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 965.192383, 520.0, 81.5, 13.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1478.0, 264.0, 81.5, 25.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 965.192383, 495.0, 81.5, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1478.0, 169.0, 83.0, 18.0 ],
					"presentation_rect" : [ 1478.0, 217.0, 0.0, 0.0 ],
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-19::obj-19::obj-37" : [ "flonum[20]", "flonum[6]", 0 ],
			...
			"obj-19::obj-19::obj-39" : [ "flonum[18]", "flonum[7]", 0 ],
			"obj-19::obj-48::obj-35" : [ "flonum[19]", "flonum[5]", 0 ],
			...
			"obj-19::obj-48::obj-58" : [ "flonum[17]", "flonum[8]", 0 ],
